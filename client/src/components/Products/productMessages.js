...
class products extends React.Component{  
 constructor(props){
    ...
    handleDelete(id){
        ...
        const request = `/users/${this.state.userId}/userProducts/${this.props.match.params.id}/productNotes/${id}`
       ...
       handleCreate(){
        ...
        const request = `/users/${this.state.userId}/userProducts/${this.props.match.params.id}/productNotes`
